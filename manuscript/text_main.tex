...
Pathogen genome sequences can provide information on transmission chains and, potentially, how public health measures and travel effect transmission. Here we use SARS-CoV-2 sequences from approximately \overallsamplingpercent\% of all confirmed cases in Switzerland from the first case on 25. Feb. through \maxdate\ to quantify transmission dynamics in Switzerland. We developed a two-step pyhylogenetic/phylodynamic analysis framework to analyze \nfocalsamples\ genomes from Switzerland in $\sim$12 hours. We report estimates across two extreme resolutions of phylogenetic uncertainty, since SARS-CoV-2 sampling exceeds viral diversity. Using our approach, we estimate border closures in Spring 2020 reduced newly sampled lineages each month by at least 83\%. We also estimate that during Summer 2020, lineages spread 40-60\% faster just after import and slowed down once sampled. We hypothesize this summertime ``burst-and-bust'' transmission pattern may be due to  test-trace-isolate measures or denser contact networks surrounding returning travellers. Our analysis aims to help understand the importance of international travel towards a national epidemic, an increasingly relevant topic as global vaccination campaigns continue at an uneven pace and new variants of concern spread internationally.
\end{abstract}
...
\includegraphics[width=0.4\linewidth]{figures/bdsky_2021-08-18/CT_conditionedDamping_NZL.pdf}
