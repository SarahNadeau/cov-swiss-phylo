...
Pathogen genome sequences can provide information on transmission chains and how public health measures effect transmission. Here we use SARS-CoV-2 sequences from approximately \overallsamplingpercent\% of all confirmed cases in Switzerland from the first case on 25. Feb. through \maxdate\ to quantify transmission dynamics in Switzerland. In contrast to some other studies, we report estimates across the range of plausible phylogenies since SARS-CoV-2 sampling is high relative to viral diversity. Using our approach, we show robust signal in SARS-CoV-2 transmission chains for a 40-60\% slow-down in transmission upon sampling when overall case counts are low. This effect is potentially due to test-trace-isolate measures, though we cannot exclude other unknown mechanisms. These analyses aim to help us understand the importance of international travel towards a national epidemic, an increasingly relevant topic as global vaccination campaigns continue at an uneven pace and new variants of concern spread internationally.
\end{abstract}
