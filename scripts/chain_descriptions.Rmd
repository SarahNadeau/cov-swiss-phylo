...
introductions_and_persistors_summary_stats <- chain_summary_stats %>%
  ...
  summarise(n_introductions = n(),
   ...
   mutate(grey_out = case_when(
   statistic == "n_introductions" & first_sample_month == "2020-12-01" ~ T,
   statistic == "frac_60_day_persistor" & first_sample_month %in% c("2020-10-01", "2020-11-01", "2020-12-01") ~ T,
   T ~ F))

statistic_labels <- c("Number of newly sampled introductions", "Fraction of introductions still spreading after 60 days")
