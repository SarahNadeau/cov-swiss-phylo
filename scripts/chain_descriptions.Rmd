...
cat("\\newcommand\\minlargestchainsper{", largest_chains_percent_min, "}\n", sep = "")
...
cat("\\newcommand\\maxlargestchainsper{", largest_chains_percent_max, "}\n", sep = "")
...
n_spanning_chains_min <- unlist(chain_longevity_stats %>%
  ...
  ungroup() %>%
  select(n_chains))
cat("\\newcommand\\nspanningchainsmin{", n_spanning_chains_min, "}\n", sep = "")
...
n_spanning_chains_max <- unlist(chain_longevity_stats %>%
  ...
  ungroup() %>%
  select(n_chains))
cat("\\newcommand\\nspanningchainsmax{", n_spanning_chains_max, "}\n", sep = "")
```
