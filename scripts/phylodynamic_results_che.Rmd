...
writeLines(text = paste0("\\newcommand\\summermaxdamplingpercentmedianCHEnosampUB{", 
...
writeLines(text = paste0("\\newcommand\\summermindamplingpercentmedianCHEnosampUB{", 
                         summer_min_dampling_percent_median_CHE_no_sampUB, "}"), con = con)

close(con)

system("cp figures/contact_tracing_factor_no_sampUB.pdf ../../../../figures/CHE_contact_tracing_factor_no_sampUB.pdf")
