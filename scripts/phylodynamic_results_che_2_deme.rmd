...
```{r}
SS_inflation_factor <- ggplot(data = SS_data, aes(x = SSInflation)) +
  geom_histogram() +
  shared_theme +
  labs(x = ss_factor_x_lab, y = ct_factor_y_lab)
show(SS_inflation_factor)
ggsave("figures/super_spreading_factor.pdf", width = single_col_width, height = single_col_width * 0.75, units = "cm")

SS_type_frequencies <- ggplot(data = SS_data, aes(x = typeFrequencies.1)) +
  geom_histogram() +
  shared_theme +
  labs(x = "Fraction of population with higher transmission rate", y = ct_factor_y_lab)
show(SS_type_frequencies)
ggsave("figures/super_spreading_type_frequency.pdf", width = single_col_width, height = single_col_width * 0.75, units = "cm")
```
