...
Plot introductions vs. persistence
...
plot_grid(main_plots[[1]], main_plots[[2]], ncol = 2, labels = "AUTO", rel_widths = c(1, 0.8))

ggsave("figures/introductions_vs_persistence_v2.png",
